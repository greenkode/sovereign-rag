...
data class PhoneNumber(val value: String, val locale: Locale) : java.io.Serializable {
    ...
    fun toInternationalFormat(): String {
        try {
            ...
            if (!util.isValidNumber(number)) throw InvalidRequestException(
            ...
            throw InvalidRequestException("Invalid phone number format [$value]")
        }
    }
