...
import nl.compilot.ai.security.authentication.TenantAuthenticationProvider
...
class SecurityConfig(
    ...
    fun passwordEncoder(): PasswordEncoder {
        val encoders = mutableMapOf<String, PasswordEncoder>(
            "bcrypt" to org.springframework.security.crypto.bcrypt.BCryptPasswordEncoder(12)
        )
        return org.springframework.security.crypto.password.DelegatingPasswordEncoder("bcrypt", encoders)
    }
