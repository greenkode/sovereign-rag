...
import ai.sovereignrag.process.domain.model.ProcessEventTransition
import ai.sovereignrag.process.domain.model.ProcessRequest
import ai.sovereignrag.process.domain.model.ProcessRequestData
import ai.sovereignrag.process.domain.model.ProcessStakeholder
import ai.sovereignrag.process.domain.model.SrProcess
...
class ProcessEntity(
    ...
    @BatchSize(size = 20) val requests: MutableSet<ProcessRequestEntity> = mutableSetOf(),
