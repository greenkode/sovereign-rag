...
import ai.sovereignrag.notification.app.datasource.ReadWriteRoutingDataSource
...
class DataSourceConfiguration {
    ...
    fun dataSource(
        ...
        log.info { "Notification database routing configured: writes -> primary, reads -> replica" }
